...
export const mockPosts: Post[] = [
  { id: 'p_87921', type: 'work', title: '给闺蜜的生日礼物 🎁', cover: postCovers[0], images: postCovers.slice(0, 9), desc: '第一次做拼豆，给闺蜜的生日礼物🎁', author: { id: 'u_10001', nickname: '小美' }, create_time: '2026-06-07 09:30', ip: '123.125.*.*', device: 'iPhone 14 Pro', risk_level: 'none', topics: ['#生日礼物', '#闺蜜', '#拼豆日常'], diagram_id: 'd_xxxxx', status: 'pending' },
  { id: 'p_87922', type: 'tutorial', title: '拼豆技巧：渐变色的取色思路', cover: postCovers[1], images: postCovers.slice(0, 5), desc: '分享一下我在做渐变色图案时的心得...', author: { id: 'u_10002', nickname: '小红' }, create_time: '2026-06-07 08:14', ip: '124.230.*.*', device: 'Xiaomi 14', risk_level: 'none', topics: ['#教程', '#渐变色'], status: 'pending' },
  { id: 'p_87923', type: 'question', title: '求助：MARD 色板 H12 缺货哪里买？', cover: postCovers[2], images: [postCovers[2]], desc: 'H12 缺货好久了，求推荐哪里能买到', author: { id: 'u_10003', nickname: '豆豆爱拼' }, create_time: '2026-06-07 07:50', ip: '113.108.*.*', device: 'Huawei P60', risk_level: 'low', risk_tags: ['可能有联系方式'], topics: ['#提问', '#色号'], status: 'pending' },
  { id: 'p_87924', type: 'work', title: '樱花树 50×50 完工啦！', cover: postCovers[3], images: postCovers.slice(0, 3), desc: '熬了 3 个晚上终于完工', author: { id: 'u_10004', nickname: '拼图小子' }, create_time: '2026-06-06 22:18', ip: '117.136.*.*', device: 'iPhone 13', risk_level: 'none', topics: ['#樱花', '#春'], status: 'pending' },
  { id: 'p_87925', type: 'work', title: '加我微信拼豆交流群（看图）', cover: postCovers[4], images: [postCovers[4]], desc: '扫码进群', author: { id: 'u_10005', nickname: '阿狸的店' }, create_time: '2026-06-06 20:43', ip: '114.88.*.*', device: 'OPPO Reno 11', risk_level: 'high', risk_tags: ['联系方式', '引流'], topics: [], status: 'pending' },
  { id: 'p_87926', type: 'work', title: '星空物语 80×80 大作分享', cover: postCovers[5], images: postCovers.slice(0, 5), desc: '80×80 的大作品', author: { id: 'u_10006', nickname: '星空物语' }, create_time: '2026-06-06 18:11', ip: '119.123.*.*', device: 'iPhone 15 Pro Max', risk_level: 'none', topics: ['#星空'], status: 'pending' },
  { id: 'p_87927', type: 'question', title: '第一次做拼豆 求指点', cover: postCovers[6], images: [postCovers[6]], desc: '有什么入门建议？', author: { id: 'u_10007', nickname: '毛线球' }, create_time: '2026-06-06 16:32', ip: '111.172.*.*', device: 'iPhone 12', risk_level: 'none', topics: ['#新手'], status: 'pending' },
  { id: 'p_87928', type: 'work', title: '我的圣诞老人成品', cover: postCovers[7], images: postCovers.slice(0, 4), desc: '送给孩子的礼物', author: { id: 'u_10003', nickname: '豆豆爱拼' }, create_time: '2026-06-05 20:11', ip: '113.108.*.*', device: 'Huawei P60', risk_level: 'none', topics: ['#节日', '#圣诞'], status: 'approved' },
  { id: 'p_87929', type: 'tutorial', title: '如何避免拼豆作品褪色', cover: postCovers[0], images: postCovers.slice(0, 3), desc: '拼豆作品褪色的几个原因...', author: { id: 'u_10002', nickname: '小红' }, create_time: '2026-06-05 14:00', ip: '124.230.*.*', device: 'Xiaomi 14', risk_level: 'none', topics: ['#教程'], status: 'approved' }
]
...
export const mockTemplates: Template[] = [
  { id: 't_001', name: '圣诞老人', cover: postCovers[0], previews: postCovers.slice(0, 3), category: '1', category_id: '1', category_name: '节日', tags: ['圣诞', '老人'], source: 'official', creator_id: 'sys', creator_name: '系统管理员', board_size: '50×50', color_count: 28, total_beads: 5000, difficulty: 'beginner', style: '写实', duration: '8-10 小时', status: 'approved', submit_time: '2026-06-01', use_count: 1234 },
  { id: 't_002', name: '皮卡丘', cover: postCovers[1], previews: postCovers.slice(1, 4), category: '2', category_id: '2', category_name: '卡通', tags: ['宠物小精灵', '黄'], source: 'creator', creator_id: 'u_10006', creator_name: '星空物语', board_size: '60×60', color_count: 35, total_beads: 6800, difficulty: 'intermediate', style: '卡通', duration: '12-15 小时', status: 'pending', submit_time: '2026-06-06', use_count: 0 },
  { id: 't_003', name: '樱花树', cover: postCovers[2], previews: postCovers.slice(2, 5), category: '3', category_id: '3', category_name: '风景', tags: ['樱花', '树', '春'], source: 'official', creator_id: 'sys', creator_name: '系统管理员', board_size: '50×50', color_count: 24, total_beads: 4500, difficulty: 'beginner', style: '写意', duration: '6-8 小时', status: 'approved', submit_time: '2026-05-20', use_count: 2341 },
  { id: 't_004', name: '招财猫', cover: postCovers[3], previews: postCovers.slice(3, 6), category: '2', category_id: '2', category_name: '卡通', tags: ['猫', '招财'], source: 'creator', creator_id: 'u_10003', creator_name: '豆豆爱拼', board_size: '40×40', color_count: 18, total_beads: 3200, difficulty: 'beginner', style: '卡通', duration: '4-6 小时', status: 'pending', submit_time: '2026-06-07', use_count: 0 },
  { id: 't_005', name: '玫瑰花', cover: postCovers[4], previews: postCovers.slice(0, 3), category: '4', category_id: '4', category_name: '花卉', tags: ['玫瑰', '红'], source: 'official', creator_id: 'sys', creator_name: '系统管理员', board_size: '50×50', color_count: 32, total_beads: 5200, difficulty: 'intermediate', style: '写实', duration: '10-12 小时', status: 'approved', submit_time: '2026-04-15', use_count: 892 },
  { id: 't_006', name: '小熊维尼', cover: postCovers[5], previews: postCovers.slice(1, 4), category: '2', category_id: '2', category_name: '卡通', tags: ['迪士尼', '小熊'], source: 'creator', creator_id: 'u_10001', creator_name: '小美', board_size: '50×50', color_count: 22, total_beads: 4100, difficulty: 'beginner', style: '卡通', duration: '6-8 小时', status: 'rejected', submit_time: '2026-05-25', use_count: 0 },
  { id: 't_007', name: '星空', cover: postCovers[6], previews: postCovers.slice(2, 5), category: '3', category_id: '3', category_name: '风景', tags: ['星空', '夜景'], source: 'official', creator_id: 'sys', creator_name: '系统管理员', board_size: '80×80', color_count: 45, total_beads: 12000, difficulty: 'advanced', style: '抽象', duration: '20-30 小时', status: 'approved', submit_time: '2026-03-12', use_count: 3456 },
  { id: 't_008', name: '复活节蛋', cover: postCovers[7], previews: postCovers.slice(3, 6), category: '1', category_id: '1', category_name: '节日', tags: ['复活节', '蛋'], source: 'creator', creator_id: 'u_10004', creator_name: '拼图小子', board_size: '30×30', color_count: 12, total_beads: 1800, difficulty: 'beginner', style: '装饰', duration: '2-3 小时', status: 'offline', submit_time: '2026-02-28', use_count: 567 }
]
